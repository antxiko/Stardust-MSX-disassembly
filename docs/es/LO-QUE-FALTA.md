...
El tercero es el que cuesta, y va así:
    ...
    ------------------------------------------------------
    total            333 rutinas, 181 comentadas (54 %)

O sea que **quedan 152 sin comentar**. La cifra la mide
...
- **Comentar las 152 rutinas que quedan.** Están acotadas y con nombre; falta
