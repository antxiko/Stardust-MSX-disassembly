...
The third one is the expensive one, and it stands here:
    ...
    ship stage       189 routines, 105 commented (56 %)
    on-foot stage    144 routines,  71 commented (49 %)
    ------------------------------------------------------
    total            333 routines, 176 commented (53 %)

So **157 are left**. The figure is measured by `tools/rutinas_comentadas.py`
...
- **Commenting the 157 routines that are left.** They are bounded and named;
