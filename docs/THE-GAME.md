...
being 24 characters wide and each tile being four —the buffer's axes are easy
to read backwards, and with the right width the maps come out symmetrical and
with their structures whole—.
