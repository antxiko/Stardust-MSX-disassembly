...
TXT = {
    "es": dict(
        ...
        aviso="<b>Esto no está terminado, y se sigue trabajando en ello.</b> Que "
              ...
              "qué sirve cada uno. Quedan 4089 bytes sin identificar y buena "
        ...
        cifras=[("100%", "del binario con dueño"), ("128", "rutinas identificadas"),
                ("7+1", "zonas de naves, y una a pie"), ("28.172", "bytes de código"),
                ("65.689", "bytes de datos"), ("4.089", "bytes sin identificar")],
    ...
    "en": dict(
        ...
        aviso="<b>This is not finished, and work continues.</b> The budget closing "
              ...
              "measurement— <b>not</b> that its purpose is known. 4089 bytes "
        ...
        cifras=[("100%", "of the binary owned"), ("128", "routines identified"),
                ("7+1", "ship zones, plus one on foot"), ("28,172", "bytes of code"),
                ("65,689", "bytes of data"), ("4,089", "bytes unidentified")],
...
HALLAZGOS = {
    "es": [
        ...
        ("Una cobertura que era mentira, dos veces",
         ...
         "lado. La cobertura real del bloque es del <b>25,9 %</b>, y la de la "
    ...
    "en": [
        ...
        ("A coverage figure that was a lie, twice over",
         ...
         "<b>25.9%</b>, and the second part's rose to <b>51.3%</b> when its two "
