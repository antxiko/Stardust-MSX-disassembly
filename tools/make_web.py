...
TXT = {
    "es": dict(
        ...
        aviso="<b>Esto no está terminado, y se sigue trabajando en ello.</b> Que "
              ...
              "qué sirve cada uno. Quedan 1934 bytes sin identificar y buena "
        ...
        cifras=[("100%", "del binario con dueño"), ("143", "rutinas identificadas"),
                ...
                ("70.637", "bytes de datos"), ("1.934", "bytes sin identificar")],
    ...
    "en": dict(
        ...
        aviso="<b>This is not finished, and work continues.</b> The budget closing "
              ...
              "measurement— <b>not</b> that its purpose is known. 1934 bytes "
        ...
        cifras=[("100%", "of the binary owned"), ("143", "routines identified"),
                ...
                ("70,637", "bytes of data"), ("1,934", "bytes unidentified")],
